...
(function (w) {
  'use strict';
  // 后端 = 香港服务器 kids-api-node（自家域 https://guodudugame.com/api，免鉴权公开）。
  // 账号安全由后端「账号密码(scrypt)+自签 token(HMAC)」保证，无平台风控。
  // 孩子走微信无需加白名单；若用学习机自带浏览器，绿网需含 guodudugame.com
  var API = 'https://guodudugame.com/api';
